...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/i2c_t3/examples/dual_bus_master_slave/dual_bus_master_slave.ino 

INO_DEPS += \
./libraries/i2c_t3/examples/dual_bus_master_slave/dual_bus_master_slave.ino.d 


# Each subdirectory must supply rules for building sources it contributes
libraries/i2c_t3/examples/dual_bus_master_slave/dual_bus_master_slave.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/i2c_t3/examples/dual_bus_master_slave/dual_bus_master_slave.ino
	@echo 'Building file: $<'
