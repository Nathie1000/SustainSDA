...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/i2c_t3/examples/interrupt/interrupt.ino 

INO_DEPS += \
./libraries/i2c_t3/examples/interrupt/interrupt.ino.d 


# Each subdirectory must supply rules for building sources it contributes
libraries/i2c_t3/examples/interrupt/interrupt.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/i2c_t3/examples/interrupt/interrupt.ino
	@echo 'Building file: $<'
