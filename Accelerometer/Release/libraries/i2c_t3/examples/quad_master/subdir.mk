...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/i2c_t3/examples/quad_master/quad_master.ino 

INO_DEPS += \
./libraries/i2c_t3/examples/quad_master/quad_master.ino.d 


# Each subdirectory must supply rules for building sources it contributes
libraries/i2c_t3/examples/quad_master/quad_master.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/i2c_t3/examples/quad_master/quad_master.ino
	@echo 'Building file: $<'
