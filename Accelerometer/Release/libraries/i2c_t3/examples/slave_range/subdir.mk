...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/i2c_t3/examples/slave_range/slave_range.ino 

INO_DEPS += \
./libraries/i2c_t3/examples/slave_range/slave_range.ino.d 


# Each subdirectory must supply rules for building sources it contributes
libraries/i2c_t3/examples/slave_range/slave_range.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/i2c_t3/examples/slave_range/slave_range.ino
	@echo 'Building file: $<'
