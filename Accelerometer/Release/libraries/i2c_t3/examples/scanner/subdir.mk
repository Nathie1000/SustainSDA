...
INO_SRCS += \
C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/i2c_t3/examples/scanner/scanner.ino 

INO_DEPS += \
./libraries/i2c_t3/examples/scanner/scanner.ino.d 


# Each subdirectory must supply rules for building sources it contributes
libraries/i2c_t3/examples/scanner/scanner.o: C:/Program\ Files\ (x86)/Arduino/hardware/teensy/avr/libraries/i2c_t3/examples/scanner/scanner.ino
	@echo 'Building file: $<'
