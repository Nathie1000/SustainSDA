...
void EM7180::SensorsDetected() {
	...
	if (featureflag & 0x01)  PRINTLN("A barometer is installed");
	if (featureflag & 0x02)  PRINTLN("A humidity sensor is installed");
	if (featureflag & 0x04)  PRINTLN("A temperature sensor is installed");
	if (featureflag & 0x08)  PRINTLN("A custom sensor is installed");
	if (featureflag & 0x10)  PRINTLN("A second custom sensor is installed");
	if (featureflag & 0x20)  PRINTLN("A third custom sensor is installed");
}
...
void EM7180::EM7180Status() {
	...
	switch (algorithmStatus) {
		case 0x01: PRINTLN("EM7180 standby status"); break;
		case 0x02: PRINTLN("EM7180 algorithm slow");  break;
		case 0x04: PRINTLN("EM7180 in stillness mode");  break;
		case 0x08: PRINTLN("EM7180 mag calibration completed");  break;
		//case 0x10: Serial.println("EM7180 magnetic anomaly detected"); break;
		//case 0x20: Serial.println("EM7180 unreliable sensor data");  break;
	}
	...
	switch (eventStatus) {
		case 0x01: PRINTLN("EM7180 CPU reset");  break;
		case 0x02: PRINTLN("EM7180 Error");  break;
		case 0x04: PRINTLN("EM7180 new quaternion result");  break;
		case 0x08: PRINTLN("EM7180 new mag result");  break;
		case 0x10: PRINTLN("EM7180 new accel result");  break;
		case 0x20: PRINTLN("EM7180 new gyro result"); break;
	}
}
...
void EM7180::sensorState() {
	...
	switch (sensorStatus) {
		case 0x01: PRINTLN("Magnetometer not acknowledging!"); break;
		case 0x02: PRINTLN("Accelerometer not acknowledging!"); break;
		case 0x04: PRINTLN("Gyro not acknowledging!"); break;
		case 0x08: PRINTLN("Magnetometer ID not recognized!"); break;
		case 0x10: PRINTLN("Accelerometer ID not recognized!"); break;
		case 0x20: PRINTLN("Gyro ID not recognized!"); break;
	}
}
