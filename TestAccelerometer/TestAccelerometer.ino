...
void setup() {
  ...
  if (!passThru) {
    ...
    readSensorFS(EM7180_mag_fs, 0x4A, 1);
    readSensorFS(EM7180_acc_fs, 0x4A, 3);
    readSensorFS(EM7180_gyro_fs, 0x4B, 1);
    ...
    EM7180SetIntInParam(0x49, 0x00); //Disable stillness mode
    // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

    //Write desired sensor full scale ranges to the EM7180
    EM7180SetModuleAccFS(0x3E8, 0x08, 0xCA);
    EM7180SetModuleAccFS(0x7D0, 0x00, 0xCB);
    ...
    else if (c == 0x71) // WHO_AM_I should always be 0x71
    {
      ...
      if (SerialDebug) {
        ...
        Serial.print("X-Axis "); Serial.print(magCalibration[0], 2);
        Serial.print("Y-Axis "); Serial.print(magCalibration[1], 2);
        Serial.print("Z-Axis "); Serial.print(magCalibration[2], 2);
      }
...
void loop() {
  ...
  if (delt_t > 500) { // update LCD once per half-second independent of read rate
    ...
    if (passThru) {
      int32_t rawPress = readBMP280Pressure();
